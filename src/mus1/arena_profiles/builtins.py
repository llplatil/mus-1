...
TAMCO_BLACK_BUCKET = ArenaProfile(
    ...
    states=(
        ArenaState(
            id="original",
            description="Original surface (publication cohort).",
        ),
        ArenaState(
            id="resanded",
            description="Surface re-sanded (validation_2026 era onwards). "
                        "Dimensions unchanged; brightness profile differs.",
        ),
    ),
    default_state_id="original",
)


# ---------------------------------------------------------------------------
# Home Depot 5-gallon orange bucket — used by P_NO pilot cohort
# ---------------------------------------------------------------------------
# Encore #34000-90; ~292 mm inside diameter. Older recording rig
# (720x480 .MOD interlaced, hand-scored era). One state.
...
HOME_DEPOT_5GAL_ORANGE = ArenaProfile(
    ...
    description="Home Depot 5-gallon orange bucket, Encore #34000-90; "
                "~292 mm inside diameter. Used for P_NO pilot cohort.",
